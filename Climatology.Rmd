...
p1 <- tm_shape(CAPE_extent) +
  tm_raster(title = "CAPE", n = 6) +
  tm_format("World", legend.position = c("right", "bottom"),
                   attr.position = c("right", "bottom"),
                   legend.frame = FALSE,
                   inner.margins = c(.1, .05, .1, .18), #bottom, left, top
                    legend.text.size = 1.1, legend.width = -0.275, legend.title.size=1.5, legend.bg.color = "white") +
tm_shape(counties) +
  tm_borders(col = "grey") +
  tm_scale_bar(width = 0.5, size = 1.2, position = c("right", "top")) +
tm_shape(states) +
  tm_borders() +
...
tm_shape(CAPE_latlon) + 
  tm_symbols(size = 1.25, col = "black", shape = 22)
```
...
p2 <- tm_shape(HLCY_extent) +
  tm_raster(title = "HLCY", n = 5) +
  tm_format("World", legend.position = c("right", "bottom"),
                   attr.position = c("right", "bottom"),
                   legend.frame = FALSE,
                   inner.margins = c(.1, .05, .1, .15), #bottom, left, top
                    legend.text.size = 1.1, legend.width = -0.25, legend.title.size=1.5, legend.bg.color = "white") +
tm_shape(counties) +
  tm_borders(col = "grey") +
  tm_scale_bar(width = 0.5, size = 1.2, position = c("right", "top")) +
tm_shape(states) +
...
p4 <- tm_shape(BS_extent) +
  tm_raster(title = "BS", n = 5) +
  tm_format("World", legend.position = c("right", "bottom"),
                   attr.position = c("right", "bottom"),
                   legend.frame = FALSE,
                   inner.margins = c(.1, .05, .1, .15), #bottom, left, top
                    legend.text.size = 1.1, legend.width = -0.2, legend.title.size=1.5, legend.bg.color = "white") +
tm_shape(counties) +
  tm_borders(col = "grey") +
  tm_scale_bar(width = 0.5, size = 1.2, position = c("right", "top")) +
tm_shape(states) +
