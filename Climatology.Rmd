...
tm_shape(longestgroup) + 
  tm_borders(col = "gray15", alpha = 1, lwd = 4) +
...
tm_shape(counties.sf) +
  ...
  tm_format("World", legend.position = c("left", "top"),
                   ...
                   inner.margins = c(.1, .3, .1, .3)) +
tm_shape(cDay1) +
  tm_symbols(size = 2, col = "green") + 
tm_shape(cDay2) +
  tm_symbols(size = 2, col = "blue") + 
tm_shape(cDay3) +
  tm_symbols(size = 2, col = "red") + 
tm_shape(cDay4) +
  tm_symbols(size = 2, col = "magenta") 
```
