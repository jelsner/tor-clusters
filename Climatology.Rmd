...
p1 <- tm_shape(CAPE_extent) +
  ...
  tm_format("World", legend.position = c("right", "bottom"),
                   ...
                   inner.margins = c(.1, 0, .1, .18), #bottom, left, top
                    legend.text.size = 1.3, legend.width = -0.275, legend.title.size=1.8, legend.bg.color = "white") +
tm_shape(counties) +
  tm_borders(col = "grey") +
  tm_scale_bar(width = 0.4, size = 1.3, position = c("right", "top")) +
tm_shape(states) +
  tm_borders() +
...
p2 <- tm_shape(HLCY_extent) +
  ...
  tm_format("World", legend.position = c("right", "bottom"),
                   ...
                   inner.margins = c(.1, 0, .1, .15), #bottom, left, top
                    legend.text.size = 1.3, legend.width = -0.25, legend.title.size=1.8, legend.bg.color = "white") +
tm_shape(counties) +
  tm_borders(col = "grey") +
  tm_scale_bar(width = 0.4, size = 1.3, position = c("right", "top")) +
tm_shape(states) +
...
p4 <- tm_shape(BS_extent) +
  ...
  tm_format("World", legend.position = c("right", "bottom"),
                   ...
                   legend.frame = FALSE,
                   inner.margins = c(.1, 0, .1, .15), #bottom, left, top
                    legend.text.size = 1.3, legend.width = -0.2, legend.title.size=1.8, legend.bg.color = "white") +
tm_shape(counties) +
  tm_borders(col = "grey") +
  tm_scale_bar(width = 0.4, size = 1.3, position = c("right", "top")) +
tm_shape(states) +
