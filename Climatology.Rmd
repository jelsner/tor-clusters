...
The analysis and modeling makes use of the Storm Prediction Center's tornado data set.
...
```{r, eval=FALSE}
library(lme4)
model0 <- lmer(log(GroupDayTotalED) ~ scale(aHLCY) + scale(aCAPE) * scale(aCIN) + (1|Mo), data = sfdf)
summary(model0)
