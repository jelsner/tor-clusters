...
tm_shape(longestgroup, projection = "merc", is.master = TRUE) + 
  ...
  tm_scale_bar(width = .5, size = 1.4, lwd = 2, color.dark = "gray70") +
  tm_compass(size = 7, lwd = 2, fontsize = 1.4, color.dark = "gray70") + 
...
tm_shape(longestdaytorns) +
  tm_symbols(size = 4, col = "ID", n = 5, palette = "seq", title.col = "September", labels = c("8th", "7th", "6th", "5th", "4th")) + 
  tm_layout(legend.title.size = 1.6,
            legend.position = c("right", "bottom"), 
            legend.stack = "horizontal",
            legend.frame = FALSE, 
            legend.text.size = 1.4, legend.width = -0.3, aes.palette = list(seq = "-Greys"))
```
...
tm_shape(stateBorders) + 
  ...
  tm_scale_bar(width = .5, size = 1.4, lwd = 2, color.dark = "gray70") +
  tm_compass(size = 7, fontsize = 1.4, lwd = 2, color.dark = "gray70") + 
...
tm_shape(May30tornadoes) +
  tm_symbols(size = 4, col = "Hour2", palette = "Greys", title.col = "Time [CST]", labels = c("6 to 12", "12 to 18", "18 to 24", "0 to 6")) +
    tm_layout(legend.title.size = 1.6,
            legend.position = c("right", "bottom"), 
            legend.stack = "horizontal",
            legend.frame = FALSE, 
            legend.text.size = 1.3, legend.width = -0.2) +
...
tm_shape(stateBorders) + 
  ...
  tm_scale_bar(width = 0.5, size = 1.5, lwd = 2, color.dark = "gray70") +
#tm_shape(counties.sf) +
#  tm_borders(col = "gray40", alpha = .3) +
