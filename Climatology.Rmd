...
tm_shape(longestdaytorns, title = "Day") +
  tm_symbols(size = 5, col = "ID", n = 5, palette = "seq", title.col = "Day", labels = c("September 8", "September 7", "September 6", "September 5", "September 4")) + 
  tm_layout(legend.title.size = 2.1,
            legend.position = c("right", "bottom"), 
            legend.stack = "horizontal",
            legend.frame = FALSE, 
            legend.text.size = 1.8, legend.width = -0.3, aes.palette = list(seq = "-BuPu"))
```
...
tm_shape(May30tornadoes) +
  tm_symbols(size = 5, col = "Hour2", palette = "seq", title.col = "Hour", labels = c("6 to 12", "12 to 18", "18 to 24", "0 to 6")) +
    tm_layout(legend.title.size = 2.1,
            legend.position = c("right", "bottom"), 
            legend.stack = "horizontal",
            legend.frame = FALSE, 
            legend.text.size = 1.8, legend.width = -0.2, aes.palette = list(seq = "-Reds")) +
...
```
**Figure 6: Number of big days by year, 1994 – 2017. Points are sized and colored by annual average ATP.**
...
ggplot(pgridL, aes(x = maxCAPE2 * 1000, y = maxBS2 * 10, fill = value)) +
 ...
 # geom_contour(aes(z = value), color = "green") + 
  scale_fill_gradient(breaks = log(10^e), labels = c(1, 3.2, 10, 32), low = "skyblue1", high = "dodgerblue4") +
  theme_bw() +
...
```
**Figure 7: Conditional standardized residuals from the linear regression model. (A) Histogram and (B) Residuals as a function of predicted values of ATP. **
