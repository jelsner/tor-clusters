...
```{r}
model1 <- lmer(log(GroupDayTotalED) ~   (1|Mo) + 
...
#         scale_color_viridis_c(guide = FALSE, direction = -1) +
         ...
         scale_x_log10(limits = c(1, 300), breaks = c(0, 10, 100, 300), labels = c(1, 10, "100", "500")) +
         scale_y_log10(limits = c(1, 300), breaks = c(0, 10, 100, 300), labels = c(1, 10, "100", "500")) +
