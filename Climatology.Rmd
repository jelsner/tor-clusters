...
ggplot() +
  geom_point(data = model1.under, 
             aes(x = GroupDayTotalED/10^12, y = preATP/10^12, fill = log10(GroupDayCas + 1)),  
            shape = 21, size = 8, show.legend = FALSE, stroke = 0, alpha = 0.8) +
      scale_fill_gradient(low = "pink", high = "firebrick3") +
  geom_point(data = model1.over, 
             aes(x = GroupDayTotalED/10^12, y = preATP/10^12, colour = log10(GroupDayCas + 1)), 
             size = 8, show.legend = FALSE,  stroke = 0, alpha = 0.8) +
