...
p1 <- tm_shape(CAPE_extent) +
  tm_raster(title = "CAPE [J/kg]", n = 6) +
  tm_format("World", legend.position = c("right", "bottom"),
                   attr.position = c("right", "bottom"),
                   legend.frame = FALSE,
                   inner.margins = c(.1, 0, .1, .18), #bottom, left, top
                    legend.text.size = 1.3, legend.width = -0.28, legend.title.size=1.5, legend.bg.color = "white") +
#tm_shape(counties) +
  #tm_borders(col = "grey") +
...
p2 <- tm_shape(HLCY_extent) +
  ...
  tm_format("World", legend.position = c("right", "bottom"),
                   ...
                   inner.margins = c(.1, 0, .1, .15), #bottom, left, top
                    legend.text.size = 1.3, legend.width = -0.25, legend.title.size=1.5, legend.bg.color = "white") +
#tm_shape(counties) +
#  tm_borders(col = "grey") +
  tm_scale_bar(width = 0.3, size = 1.3, position = c("right", "top"), color.dark = "gray70") +
tm_shape(states) +
...
p4 <- tm_shape(BS_extent) +
  tm_raster(title = "BS [m/s]", n = 5) +
  tm_format("World", legend.position = c("right", "bottom"),
                   attr.position = c("right", "bottom"),
                   legend.frame = FALSE,
                   inner.margins = c(.1, 0, .1, .15), #bottom, left, top
                    legend.text.size = 1.3, legend.width = -0.2, legend.title.size=1.5, legend.bg.color = "white") +
#tm_shape(counties) +
#  tm_borders(col = "grey") +
  tm_scale_bar(width = 0.3, size = 1.3, position = c("right", "top"), color.dark = "gray70") +
tm_shape(states) +
