...
The new GIS file contains missing geometries for over 30% of the tornadoes. The number of missing geometries is much higher starting with 1996.  Use the csv file instead from https://www.spc.noaa.gov/wcm/#data  Use the start lon/lat and create a `sp` object then convert to `sf`. Set the crs using the ESPG 4326.
```{r}
