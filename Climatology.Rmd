...
```{r, eval=TRUE}
if(!file.exists("torn")){ 
  download.file("https://www.spc.noaa.gov/gis/svrgis/zipped/torn.zip", "torn.zip", mode = "wb")
  unzip("torn.zip")
  }
```
...
#         yr <= 2014, #NARR stops at October 2014. Let's worry about this later.
         mag != -9, #removes tornadoes with missing EF rating
