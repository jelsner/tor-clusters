...
```
**Figure 1: The September 4 – 8, 2004 event has the duration of all tornado groups. The black line is the hull (spatial extent) of the entire group. Each dot is colored by a different big day.**  
...
ggplot(., aes(x = Year, y = nBD)) +
  ...
  theme(legend.position="bottom", 
        legend.background = element_rect(size=0.5, linetype="solid", 
                                  colour ="gray10"))
```
**Figure 5: Number of big days by year, 1994--2017. Points are sized by annual average ATE.**
...
```
**Figure 7: Actual versus predicted accumulated tornado energy (ATE) for the $n$ = 154 big tornado days. The predicted are based on the regression model. The color shading from dark to light indicates increasing number of casualties.**
...
```
**Figure 6: Conditional standardized residuals fromt the linear regression model. (A) Histogram and (B) Residuals as a function of predicted values of ATE.**
