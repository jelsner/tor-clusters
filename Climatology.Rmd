...
p1 <- tm_shape(CAPE_extent) +
  tm_raster(title = expression(paste("CAPE [J ", kg^-1, "]")),  n = 6) +
  tm_format("World", legend.position = c("right", "bottom"),
                   attr.position = c("right", "bottom"),
                   legend.frame = FALSE,
                   inner.margins = c(.1, 0, .1, .18), #bottom, left, top
                    legend.text.size = 1.3, legend.width = -0.28, legend.title.size=1.5, legend.bg.color = "white", title.size = 20) +
#tm_shape(counties) +
  #tm_borders(col = "grey") +
...
p2 <- tm_shape(HLCY_extent) +
  tm_raster(title = expression(paste("HLCY [",m^2, s^-2, "]")), n = 5) +
  tm_format("World", legend.position = c("right", "bottom"),
                   attr.position = c("right", "bottom"),
                   legend.frame = FALSE,
                   inner.margins = c(.1, 0, .1, .15), #bottom, left, top
                    legend.text.size = 1.3, legend.width = -0.25, legend.title.size=1.5, legend.bg.color = "white", title.size = 20) +
#tm_shape(counties) +
#  tm_borders(col = "grey") +
  tm_scale_bar(width = 0.3, size = 1.3, position = c("right", "top"), color.dark = "gray70") +
tm_shape(states) +
...
p3 <- tm_shape(CIN_extent) +
  tm_raster(title = expression(paste("CIN [J ", kg^-1, "]")), n =5) +
  tm_format("World", legend.position = c("right", "bottom"),
                   attr.position = c("right", "bottom"),
                   legend.frame = FALSE,
                   inner.margins = c(.1, 0, .1, .15), #bottom, left, top
...
p4 <- tm_shape(BS_extent) +
  tm_raster(title = expression(paste("BS [m ", s^-1, "]")), n = 5) +
  tm_format("World", legend.position = c("right", "bottom"),
                   attr.position = c("right", "bottom"),
                   legend.frame = FALSE,
                   inner.margins = c(.1, 0, .1, .15), #bottom, left, top
                    legend.text.size = 1.3, legend.width = -0.2, legend.title.size=1.5, legend.bg.color = "white", title.size = 20) +
#tm_shape(counties) +
#  tm_borders(col = "grey") +
  tm_scale_bar(width = 0.3, size = 1.3, position = c("right", "top"), color.dark = "gray70") +
tm_shape(states) +
