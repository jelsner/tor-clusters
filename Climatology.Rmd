...
Why is this important? Tornado groups represent the most concentrated large-scale risk for damage and casualties.
...
Determine the distance between tornadoes in space and time. Use a planar projection not lat/lon. See https://epsg.io/102004. Extract the coordinates of the start locations as a N by 2 matrix of numbers, where N is the number of tornadoes. Also extract the date-time as a vector of class `POSIXct`.
```{r}
...
There are 399 big days in large groups. These will be used for further analysis and modeling.
