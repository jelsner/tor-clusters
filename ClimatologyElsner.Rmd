...
Create a map showing the frequency of big tornado days by county. Transform the CRS of the county boundaries to match the CRS of `BigDaysInLargeGroups.sfdfT`.
```{r}
