...
Over the period 1994-2017 there were 137 tornado groups with at least 30 tornadoes. How many false positives? How many of these groups are not considered `outbreaks`? How many false negatives? How many previously considered `outbreaks` are missed by this algorithm?
```{r}
#FUHRMANN 2014
Groups.sfdfT %>%
  filter(Year <= 2011) %>%
