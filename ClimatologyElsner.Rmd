...
overpredday2 <- df %>%
  filter(cDate == "1999-01-22")
overpredday3 <- df%>%
  filter(cDate == "2000-05-18")
overpredday4 <- df %>%
  filter(cDate == "2004-05-24")
overpredday5 <- df %>%
  filter(cDate == "2010-10-26")
overpredday6 <- df %>%
  filter(cDate == "2011-04-19")
overpredday7 <- df %>%
  filter(cDate == "2011-04-28")
overpred <- rbind(overpredday1,overpredday2,overpredday3,overpredday4,overpredday5,overpredday6,overpredday7)
```
...
underpred <- rbind(underpredday1,underpredday2,underpredday3,underpredday4,underpredday5)
```
